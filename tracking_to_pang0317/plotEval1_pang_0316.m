...
trackers = {
            ...
            %struct('name','kittismall','namePaper','KITTI-CRAC10')
            ...
            %struct('name','acgan','namePaper','CRAC')
            ...
            %struct('name','drone','namePaper','CRAC1')
            ...
            %struct('name','kittiac1','namePaper','KITTI-CRAC2')
            ...
            struct('name','siamrpn_Drone_format','namePaper','siamRPN')
            %struct('name','meanactivate_Drone_format','namePaper','spatialrpn')
...
configPlot.fontSizeLegend = 9; %legend's fontSize %pang-fix
