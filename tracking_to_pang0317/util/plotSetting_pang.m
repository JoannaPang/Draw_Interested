plotDrawStyle={  struct('color',[1,0,0],'lineStyle','-'),...%Red
    ...
    struct('color',[0,0,0],'lineStyle','-'),...%Black   %struct('color',[1,1,0],'lineStyle','-'),...%yellow
    struct('color',[1,0,1],'lineStyle','-'),...%soft-red    
    struct('color',[0,1,1],'lineStyle','-'),...%soft-blue
    ...
    struct('color',[255,255,0]/255,'lineStyle',':'),...%yellow %%%%%%%%%%%%%%%%%%%%%%%%%%
